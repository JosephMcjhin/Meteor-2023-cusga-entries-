...
public class FlowerGun : MonoBehaviour
{
    ...
    void Launch(){
        ...
        temp.GetComponent<FlowerBullet>().init(TalentManager.instance.DamageFinal(damage, charge), TalentManager.instance.ChargeFinal(charge), Quaternion.AngleAxis(bias,Vector3.forward)*lookDirection);
    }
    /*
